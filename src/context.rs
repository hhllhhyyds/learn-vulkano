...
///
/// ```
/// use learn_vulkano::context::{VulkanoConfig, VulkanoContext};
///
/// fn example() {
...
impl VulkanoContext {
    ...
    pub fn new(mut config: VulkanoConfig) -> Self {
        ...
        config.instance_create_info.enabled_extensions =
            required_extensions(&library).union(&config.instance_create_info.enabled_extensions);
...
fn required_extensions(library: &VulkanLibrary) -> InstanceExtensions {
