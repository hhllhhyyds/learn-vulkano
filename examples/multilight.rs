...
mod deferred_frag {
    vulkano_shaders::shader! {
        ty: "fragment",
        path: "examples/multilight/shaders/deferred.frag"
    }
}
...
mod deferred_vert {
    vulkano_shaders::shader! {
        ty: "vertex",
        path: "examples/multilight/shaders/deferred.vert",
...
mod directional_frag {
    vulkano_shaders::shader! {
        ty: "fragment",
        path: "examples/multilight/shaders/directional.frag",
        types_meta: { #[derive(Clone, Copy, bytemuck::Zeroable, bytemuck::Pod)] },
    }
}
...
mod directional_vert {
    vulkano_shaders::shader! {
        ty: "vertex",
        path: "examples/multilight/shaders/directional.vert",
        types_meta: { #[derive(Clone, Copy, bytemuck::Zeroable, bytemuck::Pod)] },
    }
}
...
mod ambient_vert {
    vulkano_shaders::shader! {
        ty: "vertex",
        path: "examples/multilight/shaders/ambient.vert",
        types_meta: { #[derive(Clone, Copy, bytemuck::Zeroable, bytemuck::Pod)] },
    }
}
...
mod ambient_frag {
    vulkano_shaders::shader! {
        ty: "fragment",
        path: "examples/multilight/shaders/ambient.frag",
        types_meta: { #[derive(Clone, Copy, bytemuck::Zeroable, bytemuck::Pod)] },
    }
}
...
fn main() {
    ...
    let directional_light_r = learn_vulkano::light::DirectionalLight {
        position: [-4.0, 0.0, -4.0],
        color: [1.0, 0.0, 0.0],
    };
    let directional_light_g = learn_vulkano::light::DirectionalLight {
        position: [0.0, -4.0, 1.0],
        color: [0.0, 1.0, 0.0],
    };
    let directional_light_b = learn_vulkano::light::DirectionalLight {
        ...
        Event::RedrawEventsCleared => {
            ...
            let ambient_set = PersistentDescriptorSet::new(
                ...
                [
                    ...
                    WriteDescriptorSet::buffer(2, ambient_subbuffer),
                ],
            )
            .unwrap();
            ...
            let directional_set = PersistentDescriptorSet::new(
                ...
                [
                    ...
                    WriteDescriptorSet::buffer(3, directional_subbuffer),
                ],
            )
            .unwrap();
            cmd_buffer_builder
